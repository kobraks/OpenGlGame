...
namespace Game
{
	...
	{
		auto content = new BufferContent(access, *this);
	...
	UniformBuffer::UniformBuffer(const ShaderProgram& program, const std::string& name,
	                             BufferUsage usage) : BufferObject(BufferType::Uniform)
	{
